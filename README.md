...
| [docs/v0.7/README.md](docs/v0.7/README.md) | 路线图 **v0.7** 工序与 Workspace 抢跑代码说明（史诗交付顺序以路线图为准） |
...
**本地构建与门禁**（与 [CI](.github/workflows/ci.yml) 一致）：`mvn -B -f agent-jingu3-cs-server/pom.xml clean verify`（含单测、PMD、SpotBugs）。
