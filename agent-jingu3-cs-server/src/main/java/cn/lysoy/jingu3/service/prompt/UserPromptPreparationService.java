...
import cn.lysoy.jingu3.prompt.UserPromptFormatter;
import cn.lysoy.jingu3.service.memory.MemoryAugmentationService;
 ...
 * <p>输出作为 {@link cn.lysoy.jingu3.engine.ExecutionContext} 中的 {@code userMessage} 传入后续提示词拼装。</p>
 */
@Service
public class UserPromptPreparationService {
     ...
     * @return 进入 {@link cn.lysoy.jingu3.engine.ExecutionContext} 的增强后用户串
     */
