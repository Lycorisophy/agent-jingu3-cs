 ...
 * 指南中八种模式在引擎内均有 {@link cn.lysoy.jingu3.service.mode.ActionModeHandler} 实现，但终端用户通过 {@code mode} /
...
public final class ActionModePolicy {
    ...
    /**
     * 供 {@link cn.lysoy.jingu3.service.guard.routing.ModelIntentClassifier} 拼接系统提示，约束模型只输出允许的模式名。
     *
     * @return 逗号分隔的大写枚举名列表
     */
