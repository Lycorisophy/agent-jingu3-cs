 ...
 * {@link cn.lysoy.jingu3.service.mode.workflow.WorkflowDefinitionRegistry}。
 * <p>与 {@link cn.lysoy.jingu3.service.guard.ActionMode#WORKFLOW} 配合：客户端传 {@code workflowId} 命中本 {@code id} 后，按 {@code nodes}
