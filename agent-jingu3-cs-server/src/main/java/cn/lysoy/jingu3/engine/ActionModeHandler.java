...
public interface ActionModeHandler {
     ...
     * <p>流式场景请使用 {@link #stream} 与 {@link cn.lysoy.jingu3.stream.StreamEventSink}。</p>
     *
    ...
    /**
     * 流式执行本模式：向 {@link cn.lysoy.jingu3.stream.StreamEventSink} 推送 TOKEN、BLOCK、TOOL_RESULT、分步 step 等事件，
     * 最后须调用 {@link cn.lysoy.jingu3.stream.StreamEventSink#done()} 或 {@link cn.lysoy.jingu3.stream.StreamEventSink#error(String)}。
     *
