 ...
 * {@code POST /api/v1/chat/stream} 返回 SSE，事件体与 WebSocket 一致，见 {@link cn.lysoy.jingu3.service.context.stream.StreamEvent}。
 */
@RestController
...
public class ChatController {
    ...
    /**
     * 同步一轮对话，体与 {@link ChatRequest} 一致；内部走意图路由与 {@link cn.lysoy.jingu3.service.guard.ModeRegistry}。
     */
    @PostMapping("/chat")
    ...
    /**
     * SSE 流式：长连接默认 10 分钟，事件 payload 为 {@code application/json} 的 {@link cn.lysoy.jingu3.service.context.stream.StreamEvent}。
     */
