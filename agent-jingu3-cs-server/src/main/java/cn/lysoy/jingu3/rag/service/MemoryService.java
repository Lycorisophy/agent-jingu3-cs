 ...
 * FACT 确认等；<strong>与对话主链路的关系</strong>：在线按需检索长期记忆走内置工具 {@code memory_search}
 *（{@link cn.lysoy.jingu3.rag.service.MilvusMemoryRetrievalService}），而非本接口的同步 CRUD。
 * <p>实现类 {@link cn.lysoy.jingu3.rag.service.DefaultMemoryService} 协调 MyBatis Mapper、向量索引器等；具体表结构与物化清单见
